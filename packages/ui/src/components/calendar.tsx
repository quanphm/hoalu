	...
	return (
		<DayPicker
			...
			classNames={{
				...
				today: cn(
					"rounded-md data-[selected=false]:bg-accent data-[selected=false]:text-accent-foreground data-[selected=true]:rounded-none",
...
function CalendarDayButton({
	...
	return (
		<Button
			...
			className={cn(
				"data-[range-end=true]:bg-primary data-[range-middle=true]:bg-transparent data-[range-start=true]:bg-primary data-[selected-single=true]:bg-primary data-[range-end=true]:text-primary-foreground data-[range-middle=true]:text-foreground data-[range-start=true]:text-primary-foreground data-[selected-single=true]:text-primary-foreground data-[selected-single=true]:hover:bg-primary data-[range-start=true]:hover:bg-primary data-[range-end=true]:hover:bg-primary data-[range-middle=true]:hover:bg-transparent group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70",
				defaultClassNames.day,
				className,
			)}
			{...props}
