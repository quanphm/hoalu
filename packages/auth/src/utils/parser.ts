/**
 * @see https://github.com/better-auth/better-auth/blob/main/packages/better-auth/src/client/parser.ts
 */
...
function betterJSONParse<T = unknown>(value: unknown, options: ParseOptions = {}): T {
