...
type AuthorizeResponse = { success: false; error: string } | { success: true; error?: undefined };
...
export function createAccessControl<TStatements extends Statements = Statements>(s: TStatements) {
	const statements = s;
	return {
...
export type AccessControl<TStatements extends Statements = Statements> = ReturnType<
	typeof createAccessControl<TStatements>
>;
