...
- If no currency is mentioned, use the first available currency or infer from context
- Match the expense to the most relevant category based on merchant name or description
- For relative dates like "yesterday", "last week", calculate from today (${context.today})
- Set confidence based on how clearly and completely the details were provided
- Only set repeat if the user explicitly says something like "every month", "weekly", etc.
